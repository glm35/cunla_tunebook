...
- index des suites: si les 3 airs ont le même type, écrire le type en
  premier (pas italique) puis les 3 airs sans le type. Par exemple:
  "Jigs: Father O'Flynn (p.12), Brid Harper's (p.12)"
- index des suites: pouvoir donner un nom à une suite. e.g.
  "The Oran Set"
